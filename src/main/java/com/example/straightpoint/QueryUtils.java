...
/**
 * Helper methods related to requesting and receiving news articles data from NEWSAPI.ORG.
 */
public final class QueryUtils {
    ...
    /**
     * Query the NEWSAPI.org dataset and return a list of {@link NewsItems} objects.
     */
    public static List<NewsItems> fetchNewsItemsData(String requestUrl) {
        // Create URL object
        ...
        List<NewsItems> newsItems = extractNewsItemsFromJSON(jsonResponse);
     ...
     */
    private static List<NewsItems> extractNewsItemsFromJSON(String newsItesmJSON) {
        Log.i("QueryUtils","QueryUtil extractNewsItemsFromJson Method");

        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(newsItesmJSON)) {
            return null;
        }
        ...
        try {
            ...
            // build up a list of NewsItems objects with the corresponding data.
            JSONObject baseJSONResponse =  new JSONObject(newsItesmJSON);
            ...
            for(int i=0; i<articleArray.length(); i++){
                ...
                String websiteName = source.getString("name");
                ...
                NewsItems newsItem = new NewsItems(websiteName, articleTitle, imageURL, time, url);
